                    ...
                    <td style="padding:35px;">
                        ...
                        <h1 style="margin-top:0; font-size:22px; font-weight:bold; color:#333333;">
                            ...
                            <span style="color:#3869D4;">
                                {{ $invite->organisation->name ?? config('app.name') }}
                            </span>
                        </h1>
                        ...
                        <p style="font-size:16px; line-height:1.5em;">
                            Owner of <strong>{{ $invite->organisation->name }}</strong> added your e‑mail to their workspace.
                            Click the button below to accept the invitation.
                            You may need to log in first if you aren’t already.
                        </p>
                        ...
                        {{-- Fallback URL --}}
                        <p style="font-size:16px; line-height:1.5em;">
                            If you’re having trouble with the button, copy and paste the URL below into your browser:
                        </p>
